...
import { getSavingsById } from 'apiSdk/savings';
import { SavingsInterface } from 'interfaces/savings';

function SavingsViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('savings', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/savings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Goal Amount" text={data?.goal_amount} />

                <FormListItem label="Current Amount" text={data?.current_amount} />
