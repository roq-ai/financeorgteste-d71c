...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bills', path: '/bills', entity: 'bills', service: AccessServiceEnum.PROJECT, icon: FiFileMinus },
    { name: 'Earnings', path: '/earnings', entity: 'earnings', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'Payments', path: '/payments', entity: 'payments', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
    { name: 'Savings', path: '/savings', entity: 'savings', service: AccessServiceEnum.PROJECT, icon: FiSave },
